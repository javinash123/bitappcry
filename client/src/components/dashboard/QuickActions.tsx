...
export function QuickActions() {
  const actions = [
    { label: "New Invoice", icon: Plus, color: "text-white", bg: "bg-primary" },
    { label: "All Invoices", icon: FileText, color: "text-blue-600", bg: "bg-blue-50 group-hover:bg-blue-100" },
    { label: "Items/Taxes", icon: Settings2, color: "text-purple-600", bg: "bg-purple-50 group-hover:bg-purple-100" },
    { label: "Transactions", icon: History, color: "text-orange-600", bg: "bg-orange-50 group-hover:bg-orange-100" },
    { label: "Profile", icon: Building, color: "text-slate-600", bg: "bg-slate-50 group-hover:bg-slate-100" },
    { label: "Banking", icon: Landmark, color: "text-emerald-600", bg: "bg-emerald-50 group-hover:bg-emerald-100" },
  ];
